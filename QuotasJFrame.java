 ...
 * @author José Martins
 */
public class QuotasJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Adicionar Novo Sócio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuotasJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuotasJFrame().setVisible(true);
            }
        });
    }
